...
// skip tells jest to skip any test that is not ready
...
describe("Tabletop RPG gamer wants to...", () => {
        ...
        describe("Tabletop gamer wants to roll a variety of dice. Specifically, they want to roll a...", () => {
